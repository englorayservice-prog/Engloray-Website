...
const RayMartNavbar = () => {
    ...
    const menuData = [
        { id: 'home', title: 'Home', route: '/raymartPage' },
        { id: 'services', title: 'Services', route: '/raymartPageTwo' },
        { id: 'products', title: 'Products', route: '/raymartPageThree' }
    ];

    // Function to handle Home button click
    const handleHomeClick = () => {
        if (location.pathname === '/raymartPage') {
            window.scrollTo({ top: 0, behavior: 'smooth' });
        } else {
            navigate('/raymartPage');
        }
        closeMobileMenu();
    };
        ...
        <>
            <div>
                <Helmet>
                    ...
                    <meta property="og:title" content="RayMartNavbar" />
                ...
                >
                    <nav className="tlnbn-single-line-nav">
                        <div className="tlnbn-nav-content" style={{ background: '#ffffff', border: '1px solid #e2e8f0', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)', marginTop: '0' }}>
                            {/* 1. Logo */}
