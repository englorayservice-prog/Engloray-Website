...
const Navbar = () => {
    ...
    // Navbar always stays visible (fixed)
    useEffect(() => {
        setShowNavbar(true);
    }, []);
                        ...
                        <ul className="desktop-menu">
                            ...
                            <li>
                                <a
                                    href="#!"
                                    className='anchorLink'
                                    onClick={(e) => { e.preventDefault(); handleMenuClick('serviceSection'); }}
                                >
                                    <p>Service</p>
                                </a>
                            </li>
                            <li>
                                <a
                                    href="#!"
                                    className='anchorLink'
                                    onClick={(e) => { e.preventDefault(); handleMenuClick('portfolio'); }}
                                >
                                    <p>Works</p>
                                </a>
                            </li>
                            <li>
                                <a
                                    href="#!"
                                    className='anchorLink'
                                    onClick={(e) => { e.preventDefault(); handleMenuClick('techGroup-testimonialsSection'); }}
                                >
                                    <p>Client</p>
                                </a>
                            </li>
                            <li>
                                <a
                                    href="#!"
                                    className='anchorLink'
                                    onClick={(e) => { e.preventDefault(); handleMenuClick('internship'); }}
                                >
                                    <p>Internship</p>
                                </a>
                            </li>
                            <li>
                                <a
                                    href="#!"
                                    className='anchorLink'
                                    onClick={(e) => { e.preventDefault(); handleMenuClick('benefits-cta-main-section'); }}
                                >
                                    <p>Contact</p>
                                </a>
                            </li>
