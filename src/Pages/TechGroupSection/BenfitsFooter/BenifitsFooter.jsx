...
const BenefitsFooter = ({ onOpenInternshipForm }) => {
  ...
  // Icon colors for benefits - keeping the same colors
  const benefitColors = {
    rocket: '#FF6B6B',     // Red
    userTie: '#4ECDC4',    // Teal
    certificate: '#FFD166', // Yellow
    chartLine: '#06D6A0',   // Green
    lightbulb: '#FFB347',   // Orange
    handsHelping: '#6C5B7B',  // Purple
    laptop: '#3498db',      // Blue
    users: '#e74c3c',       // Red
    award: '#f39c12',       // Orange
    brain: '#9b59b6',       // Purple
    handshake: '#1abc9c',   // Teal
    clock: '#e67e22',       // Orange
    headset: '#3498db',     // Blue
    mobile: '#2c3e50',      // Dark Blue
    search: '#27ae60',      // Green
    cogs: '#7f8c8d'         // Gray
  };

  // Updated benefits array with 6 different icons
  const benefits = [
    {
      icon: faLaptopCode,
            ...
            <div className="benefits-main-section new-benefits-design">
              ...
              <div className="benefits-main-header left-aligned-header">
                ...
                <div className="title-with-image-container">
                  ...
                  {/* <div className="title-image-wrapper left-center">
                    <img src={titleImage} alt="Title decoration" className="title-image" />
                  </div> */}
                </div>
              </div>
                  ...
                  <div className="benefits-cta-footer-links">
                    ...
                    <div className="benefits-cta-footer-column">
                      ...
                      <ul className="benefits-cta-footer-list benefits-cta-contact-list">
                        <li>engloraytechgroup@gmail.com</li>
                        <li>+91 6381759909</li>
                        <li>+91 6366945920</li>
