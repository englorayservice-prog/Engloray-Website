      ...
      <div className="GD-content" ref={containerRef}>
        ...
        >
          ...
          <div className="GD-hero-typography">
            <div className="GD-hero-line GD-hero-line-1">
              <svg className="GD-sparkle-icon-large" viewBox="0 0 24 24" width="40" height="40">
                <path d="M12 0L14.59 9.41L24 12L14.59 14.59L12 24L9.41 14.59L0 12L9.41 9.41L12 0Z" fill="currentColor" />
              </svg>
            ...
            <div className="GD-hero-line GD-hero-line-2">
              ...
              <svg className="GD-sparkle-icon-small" viewBox="0 0 24 24" width="20" height="20">
                <path d="M12 0L14.59 9.41L24 12L14.59 14.59L12 24L9.41 14.59L0 12L9.41 9.41L12 0Z" fill="currentColor" />
              </svg>
            </div>

            <div className="GD-hero-line GD-hero-line-3">
              <svg className="GD-sparkle-icon-small" viewBox="0 0 24 24" width="25" height="25" style={{ marginRight: '0rem' }}>
                <path d="M12 0L14.59 9.41L24 12L14.59 14.59L12 24L9.41 14.59L0 12L9.41 9.41L12 0Z" fill="currentColor" />
              </svg>
              <h1 className="GD-hero-title-word" style={{ marginLeft: '-1rem' }}>Together</h1>
        ...
        <section className="GD-section GD-dream-navigator-section" id="dream-navigator">
          <div className="GD-dn-container">
            ...
            <div className="GD-dn-resources-title-row" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginTop: '2rem', marginBottom: '2rem', position: 'relative' }}>
              <div style={{ flex: 1 }}>
                <h2 className="GD-dn-title">
                  DESIGN
                  <svg className="GD-dn-icon-sparkle" viewBox="0 0 24 24" width="30" height="30">
            ...
            <div className="GD-dn-visual-row GD-resources-accordion">
              {courseResources.slice(0, 6).map((resource, index) => {
                ...
                if (isActive) {
                  return (
                    <div key={resource.id} className="GD-accordion-panel GD-accordion-expanded GD-dn-spark-card" style={{ background: index % 2 === 0 ? 'linear-gradient(135deg, #e0ebff 0%, #b3caff 100%)' : 'linear-gradient(135deg, #eae0ff 0%, #cbb3ff 100%)' }}>
            ...
            <div className="GD-dt-cards-wrapper">
              <div className="GD-dt-cards">
                {[...testimonials, ...testimonials].map((testimonial, index) => {
                  const cardClassIndex = (index % 3) + 1;
                  const imgMap = {
                    1: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",  // Arun kumar
                    2: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",  // Anitha M
                    3: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",  // Karthik P
                    4: "https://images.unsplash.com/photo-1517841905240-472988babdf9?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80 ",  // Deepika R
                    5: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",  // Sarah J
                    6: "https://images.unsplash.com/photo-1599566150163-29194dcaad36?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",  // Michael T
                    7: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",  // Priya S
                    8: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",  // David Chen
                  };
                  const photoUrl = imgMap[testimonial.id] || imgMap[1];
