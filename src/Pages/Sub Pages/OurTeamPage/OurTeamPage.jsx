...
import HeroSideLeft from '../../../assets/Hero-side-left.jfif';
import HeroSideRight from '../../../assets/hero_side_right.png';
  ...
  const teamMembers = [
    {
      ...
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRx66jJdzTj2zusM6z-JGFAjoGMQGuSBAmQzw&s", /* UI/UX abstract */
    ...
    <div className="otp-page">
      ...
      <header className="otp-new-header">
        <div className="otp-header-container">
          {/* Side Floating Cards - Bento Layout */}
          <div className="otp-side-card otp-side-left">
            <div className="otp-side-section-top">
              <div className="otp-card-head">
                <img src={HeroSideLeft} alt="Visionary" className="otp-side-img" />
              </div>
              <div className="otp-card-wave-bar">
                <div className="otp-wave-icon"><FontAwesomeIcon icon={faBolt} /></div>
                <div className="otp-wave-bars"><span></span><span></span><span></span><span></span></div>
              </div>
            ...
            <div className="otp-side-section-bottom">
              <div className="otp-listeners-row">
                <div className="otp-mini-avatars">
                  <div className="ma-1"></div><div className="ma-2"></div><div className="ma-3"></div>
                </div>
                <div className="otp-listeners-content">
                  <span className="otp-l-count">+100K Worldwide listener</span>
          ...
          <div className="otp-side-card otp-side-right">
            <div className="otp-side-section-top">
              <div className="otp-card-head">
                <img src={HeroSideRight} alt="Strategy" className="otp-side-img" />
              </div>
          ...
          <div className="otp-cta-form">
            <div className="otp-input-group">
              <FontAwesomeIcon icon={faArrowRight} className="otp-input-icon" />
              <button className="otp-btn-access">Work With US </button>
            </div>
          </div>

          <div className="otp-brand-footer">
      ...
      <main className="otp-main-content">
        ...
        {/* Team Projects */}
        <section className="otp-projects-section-redesign">
          <div className="otp-projects-left">
            <div className="otp-projects-left-content">
              <span className="otp-projects-pill">Our Projects</span>
              <h2 className="otp-projects-main-title">
                Our Professional <br />
                <span className="otp-projects-title-accent">Amazing Services Your Business</span>
              </h2>
              <p className="otp-projects-description">
              ...
              <div className="otp-projects-quote-container">
                <div className="otp-projects-quote">
                  <p>Building intelligent solutions that transform businesses to stay ahead in the digital landscape.</p>
                </div>
                <div className="otp-projects-quote">
                  <p>Designing seamless experiences that users love while maintaining high performance and scale.</p>
                </div>
                <div className="otp-projects-quote">
                  <p>Crafting scalable and efficient solutions tailored to the unique needs of your amazing business.</p>
                </div>
              </div>
            </div>
          </div>
          <div className="otp-projects-right">
            {/* <img src={ProjectsBg} alt="Projects" className="otp-projects-right-bg" /> */}
            <div className="otp-projects-scroll-wrapper" ref={scrollRef}>
              {teamProjects.map((project) => (
                <div key={project.id} className="otp-project-card-new">
                  <div className="otp-project-card-inner">
                    <div className="otp-project-card-top-row">
                      <div className="otp-project-icon" style={{ color: project.color }}>
                        {project.icon}
                      </div>
                      <h3 className="otp-project-card-title">{project.title}</h3>
                    </div>

                    <p className="otp-project-card-desc">{project.description}</p>

                    <div className="otp-project-tags">
                      {project.tags.map((tag, idx) => (
                        <span key={idx} className="otp-project-tag">{tag}</span>
                      ))}
                    </div>

                    <div className="otp-project-completion">
                      <div className="otp-completion-info">
                        <span>Completion</span>
                        <span>{project.completion}</span>
                      </div>
                      <div className="otp-completion-bar-bg">
                        <div
                          className="otp-completion-bar-fill"
                          style={{
          ...
          <div className="otp-container">
            ...
            <div className="otp-members-grid">
              {teamMembers.map((member) => (
                ...
                >
                  <div className="otp-member-content-news">
                    <div className="otp-member-tag-header">
                      <span className="otp-member-avatar-pill" style={{ backgroundColor: member.color }}>{member.avatar}</span>
                      <span className="otp-member-date-news">{member.date}</span>
                    </div>

                    <h3 className="otp-member-title-news">{member.name} — {member.role}</h3>
                    <p className="otp-member-excerpt-news">{member.quote}</p>

                    <div className="otp-member-skills-flow">
                      {member.skills.map((skill, index) => (
                        <span key={index} className="otp-member-skill-item">
                          <FontAwesomeIcon icon={faCheck} className="otp-skill-icon" />
                          {skill}
                        </span>
                      ))}
                    </div>

                    <div className="otp-member-footer-full">
                      <div className="otp-member-stat-box">
                        <span className="otp-stat-val">{member.experience}</span>
                        <span className="otp-stat-lbl">Experience</span>
                      </div>
                      <div className="otp-member-stat-box">
                        <span className="otp-stat-val">{member.projects}</span>
                        <span className="otp-stat-lbl">Projects Done</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="otp-team-count-container">
              <div className="otp-team-count-card">
                <div className="otp-team-count-content">
                  <span className="otp-card-watermark">TAILORED SOLUTIONS</span>
                  <h3 className="otp-card-main-title-new">Our Team Members  16+</h3>
                  <p className="otp-card-desc-new">
        ...
        <section className="otp-section otp-reviews-section">
          <div className="otp-container">
            <div className="otp-section-header">
              <h2 className="otp-section-title-reviews-new">
                CLIENT'S TRUSTED VOICE
              </h2>
            </div>

            <div className="otp-reviews-slider-wrapper">
              <div className="otp-slide-tracker">
                {teamReviews.map((review, index) => {
                  let position = 'next-slide';
                  if (index === activeReview) {
                    position = 'active-slide';
                  } else if (
                    index === activeReview - 1 ||
                    (activeReview === 0 && index === teamReviews.length - 1)
                  ) {
                    position = 'prev-slide';
                  }

                  return (
                    <div key={review.id} className={`otp-review-slide ${position}`}>
                      <div className="otp-review-card-premium">
                        <div className="otp-card-stars">
                          {[...Array(5)].map((_, i) => (
                            <FontAwesomeIcon
                              key={i}
                              icon={faStar}
                              className={i < review.stars ? "star-active" : "star-inactive"}
                            />
                          ))}
                        </div>

                        <p className="otp-premium-review-text">
                          "{review.review}"
                        </p>

                        <div className="otp-premium-user-footer">
                          <h4 className="otp-premium-user-name">
                            {review.name} — <span className="otp-premium-location">{review.location}</span>
                          </h4>
                        </div>

                        {position === 'active-slide' && (
                          <div className="otp-premium-quote-icon">
                            <svg viewBox="0 0 100 100" className="quote-svg">
                              <path d="M30 40c0-10 10-20 20-20v10c-5.5 0-10 4.5-10 10h10v20h-20v-20zm30 0c0-10 10-20 20-20v10c-5.5 0-10 4.5-10 10h10v20h-20v-20z" fill="currentColor" />
                            </svg>
                          </div>
                        )}
                      </div>
        ...
        {/* Contact Section - Redesigned matching reference */}
