    ...
    return (
        <>
            <div>
                ...
                <div
                    className="WD-scaling-outer-wrapper"
                    style={{
                        width: '100%',
                ...
                >
                    <div
                        ref={scalingRef}
                        className="WD-scaling-inner-container"
                        style={{
                                    ...
                                    <div className="WD-dn-header-row">
                                        <div className="WD-dn-header-left">
                                            <h2 className="WD-dn-title">
                                                ...
                                                <div className="WD-dn-title-line2" style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginTop: '0.5rem', flexWrap: 'nowrap' }}>
                                                    <button
                                                        className="WD-split-action-btn"
                                                        style={{ padding: '1.7rem 1.5rem', fontSize: '1rem', margin: 0, flexShrink: 0 }}
                                                        onClick={() => showLockedSectionToast("Tools, Code & Development Support")}
                                                    >
                                                        <FontAwesomeIcon icon={faLock} /> Join course to Access
                                                    </button>
                                                    <span style={{ whiteSpace: 'nowrap' }}>Development Support</span>
                                                    <svg className="WD-dn-icon-sparkle-outline" viewBox="0 0 24 24" width="30" height="30" style={{ flexShrink: 0 }}>
                                ...
                                <div className="WD-dn-container">
                                    ...
                                    <div className="WD-dn-resources-title-row" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginTop: '0', marginBottom: '2rem', position: 'relative' }}>
                                        <div style={{ flex: 1 }}>
                                            ...
                                            <div className="WD-dn-header-right" style={{ flex: 'unset', padding: '1.2rem 0 0 0' }}>
                                                ...
                                                <p>
                                                    Download valuable development templates, guides, and assets to enhance your coding process.
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="WD-dn-stats-row">
                                        ...
                                        <div className="WD-dn-socials">
                                            <span className="WD-dn-social-icon" title="Total Resources" onClick={() => scrollToSection('dream-navigator')}><FontAwesomeIcon icon={faGem} /></span>
                                            <span className="WD-dn-social-icon" title="Download All Free Resources" onClick={handleDownloadAllResources}><FontAwesomeIcon icon={faDownload} /></span>
                                            <span className="WD-dn-social-icon" title="Your Downloads" onClick={handleShowDownloadHistory}><FontAwesomeIcon icon={faTrophy} /></span>
                                        </div>
                                    </div>
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <div className="WD-Gallery-small-content-new">
                                                            ...
                                                            <span className="WD-Gallery-small-date-new" style={{ color: '#2563eb', fontWeight: '600' }}>
                                ...
                                <div className="WD-benefits-container-new">
                                    ...
                                    <div style={{ textAlign: 'center', marginBottom: '3rem', position: 'relative', zIndex: 2 }}>
                                        <h2 className="WD-section-title">
                                            ...
                                            <svg className="WD-animated-star" viewBox="0 0 24 24" width="36" height="36" style={{ verticalAlign: 'middle', marginLeft: '10px' }}>
                                                <path d="M12 0L14.59 9.41L24 12L14.59 14.59L12 24L9.41 14.59L0 12L9.41 9.41L12 0Z" fill="black" />
                                            </svg>
                                        </h2>
