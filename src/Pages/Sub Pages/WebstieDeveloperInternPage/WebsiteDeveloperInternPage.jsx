  ...
  const testimonials = [
    {
      id: 1,
      rating: 5,
      text: "Learning full-stack development from scratch at ENGLORAY helped me launch my engineering career.",
      author: "Aarav Sharma"
    },
    {
      id: 2,
      rating: 4,
      text: "I gained confidence in complex database architectures and API design.",
      author: "Priya Malhotra"
    },
    {
      id: 3,
      rating: 5,
      text: "From zero to deployed—ENGLORAY guided me through every technical hurdle.",
      author: "Rohan Varma"
    },
    {
      id: 4,
      rating: 4,
      text: "The React and Node.js training was practical and focused on industry requirements.",
      author: "Ananya Rao"
    },
    {
      id: 5,
      rating: 5,
      text: "The hands-on projects were incredible. I built a production-ready CRM in just 3 months!",
      author: "Sophie Lemoine"
    },
    {
      id: 6,
      rating: 5,
      text: "Excellent mentorship and resources. The codebase templates saved me weeks of work.",
      author: "Arjun Bhasin"
    },
    {
      id: 7,
      rating: 4,
      text: "Great logical flow. I really appreciated the focus on system design and scalability.",
      author: "Maya Holtz"
    },
    {
      id: 8,
      rating: 5,
      text: "Transformed my career. I'm now a junior developer at a leading fintech firm!",
      author: "David Karsun"
    }
  ];
  ...
  return (
    <>
      ...
      <div className="WD-content" ref={containerRef}>
        ...
        <section className="WD-section WD-dream-navigator-section">
          <div className="WD-dn-container">
            {/* Top Header Row */}
            <div className="WD-dn-header-row">
              <div className="WD-dn-header-left">
              ...
              <div className="WD-dn-header-right">
            ...
            <div className="WD-dn-resources-title-row" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginTop: '0', marginBottom: '2rem', position: 'relative' }}>
              <div style={{ flex: 1 }}>
                <h2 className="WD-dn-title">
                  ...
                  <svg className="WD-dn-icon-sparkle" viewBox="0 0 24 24" width="30" height="30" style={{ marginLeft: '10px' }}>
                    <path d="M12 0L14.59 9.41L24 12L14.59 14.59L12 24L9.41 14.59L0 12L9.41 9.41L12 0Z" fill="currentColor" />
                  </svg>
                </h2>
