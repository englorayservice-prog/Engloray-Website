        ...
        <div className="sad-page">
                ...
                <div className="sad-hero-container-new">
                    <div className="sad-hero-left-new">
                        ...
                        <div className="sad-hero-buttons-new">
                            <button className="sad-btn-get-started-new">START DEVELOPING</button>
                            <button className="sad-btn-contact-us-new">OUR STACK</button>
                        </div>
                        ...
                        <div className="sad-right-top-new">
                            ...
                            <div className="sad-avatars-row-new">
                                <div className="sad-avatar-group-new">
                                    <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Dev1" alt="Frontend Lead" />
                                    <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Dev2" alt="Backend Master" />
                                    <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Dev3" alt="DevOps Lead" />
                                </div>
            ...
            <section className="sad-about-section-new">
                <div className="sad-about-top-notch-content">
                    <span className="sad-about-left-tag">TECH STACK</span>
                </div>
                <div className="sad-about-inner-new">
                    ...
                    <div className="sad-about-right-new">
                        <div className="sad-about-detail-panel" key={selectedService}>
                            ...
                            <button className="sad-detail-cta">Start Build →</button>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="sad-elevate-section">
                <div className="sad-el-container">
                    <div className="sad-el-left">
                        <div className="sad-el-img-grid">
                            <div className="sad-el-img-item sad-el-main">
                                ...
                                <div className="sad-el-badge-volunteer">
                                    ...
                                    <div className="sad-el-vol-avatars">
                                        <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=S1" alt="s1" />
                                        <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=S2" alt="s2" />
                                        <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=S3" alt="s3" />
                            ...
                            <div className="sad-el-img-item sad-el-top-left">
                                ...
                                <div className="sad-el-float-icon">💻</div>
                            </div>
                    ...
                    <div className="sad-el-right">
                        ...
                        <h2 className="sad-el-title">Scale your software to<br />new performance peaks</h2>
                        <p className="sad-el-desc">
                            We solve complex business problems through clean, maintainable code. Our focus is on building resilient digital systems that don't just work—they excel. By prioritizing security, speed, and modularity, we ensure your software stays relevant in an ever-changing tech landscape.
                        </p>

                        <div className="sad-el-stats-new">
                            <div className="sad-el-stat-card">
                                <div className="sad-el-stat-icon-wrap">🛡️</div>
                                <div className="sad-el-stat-info">
                                    <span className="sad-el-stat-val">500+</span>
                                    <span className="sad-el-stat-txt">Active Deployments</span>
                                </div>
                            </div>
                            <div className="sad-el-stat-card">
                                <div className="sad-el-stat-icon-wrap">⚡</div>
                                <div className="sad-el-stat-info">
                                    <span className="sad-el-stat-val">10+ Years</span>
                                    <span className="sad-el-stat-txt">Dev Experience</span>
                                </div>
                            </div>
                        </div>

                        <p className="sad-el-sub-desc">
                            Modern approach to architecture meets deep engineering expertise, ensuring your product scales with your ambitions.
                        </p>

                        <button className="sad-el-btn-discover">Explore Our Stack</button>
                    </div>
                </div>
            </section>
            ...
            <section className="sad-productivity-section">
                <div className="sad-prod-container">
                    <div className="sad-prod-left">
                        <h2 className="sad-prod-title">ELEVATE YOUR BUSINESS WITH A POWERFUL BRAND</h2>
                        ...
                        <div className="sad-prod-buttons">
                            <button className="sad-btn-prod-primary">Get started</button>
                            <button className="sad-btn-prod-secondary">Talk to our team</button>
                        </div>
            ...
            <section className="sad-mission-section">
                <div className="sad-mission-container">
                    <h2 className="sad-mission-title-new">
                        OUR MISSION IS TO MAKE YOUR <span className="sad-mission-highlight-box">Business</span> BETTER THROUGH TECHNOLOGY
                    </h2>

                    <div className="sad-mission-cards-wrapper">
                        <div className="sad-mission-cards-fan">
                            {[
                                { id: 1, title: 'LOGO DESIGN', subtitle: 'Visual foundation', desc: 'Crafting unique visual identities and memorable marks that represent your core brand values.', rating: '4.9', color: '#6A26E1', icon: <svg viewBox="0 0 24 24" width="64" height="64" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round"><path d="M12 19l7-7 3 3-7 7-3-3z"></path><path d="M18 13l-1.5-7.5L2 2l3.5 14.5L13 18l5-5z"></path><path d="M2 2l7.586 7.586"></path><circle cx="11" cy="11" r="2"></circle></svg>, rot: -18, transY: 50, left: '15%' },
                                { id: 2, title: 'BRAND STRATEGY', subtitle: 'Strategic growth', desc: 'Defining your brand purpose, positioning, and personality to win market share.', rating: '4.8', color: '#F14949', icon: <svg viewBox="0 0 24 24" width="64" height="64" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><circle cx="12" cy="12" r="6"></circle><circle cx="12" cy="12" r="2"></circle></svg>, rot: -12, transY: 25, left: '26%' },
                                { id: 3, title: 'BRAND AUDIT', subtitle: 'System Review', desc: 'Performing deep-dive comprehensive brand evaluations to identify growth paths.', rating: '4.7', color: '#F7931E', icon: <svg viewBox="0 0 24 24" width="64" height="64" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line><line x1="11" y1="8" x2="11" y2="14"></line><line x1="8" y1="11" x2="14" y2="11"></line></svg>, rot: -6, transY: 8, left: '38%' },
                                { id: 4, title: 'VISUAL IDENTITY', subtitle: 'Cohesive system', desc: 'Developing a cohesive visual system with custom palettes and typography.', rating: '5.0', color: '#36B0E3', icon: <svg viewBox="0 0 24 24" width="64" height="64" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>, rot: 0, transY: 0, left: '50%' },
                                { id: 5, title: 'BRAND STORY', subtitle: 'Emotional connection', desc: 'Developing a compelling narrative and tone of voice that connects with users.', rating: '4.7', color: '#38C172', icon: <svg viewBox="0 0 24 24" width="64" height="64" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg>, rot: 6, transY: 8, left: '62%' },
                                { id: 6, title: 'DESIGN INTERFACE', subtitle: 'User experience', desc: 'Designing perfect fonts and defining a consistent tone of voice for all platforms.', rating: '4.9', color: '#4F5EDB', rot: 12, transY: 25, left: '74%', icon: <svg viewBox="0 0 24 24" width="64" height="64" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"></rect><line x1="12" y1="18" x2="12.01" y2="18"></line></svg> },
                                { id: 7, title: 'MARKET RESEARCH', subtitle: 'Deep analysis', desc: 'Performing deep market research on competitors and your brand equity.', rating: '4.6', color: '#F06292', icon: <svg viewBox="0 0 24 24" width="64" height="64" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>, rot: 18, transY: 50, left: '85%' }
                            ].map((card) => (
                                <div
                ...
                <div className="sad-agency-container">
                    ...
                    <div className="sad-agency-grid">
                        <div className="sad-agency-left">
                            <div className="sad-agency-image-wrap">
                                <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Dev Team" />
                                <div className="sad-agency-experience-badge">
                                    <span className="sad-exp-num">10+</span>
                                    <span className="sad-exp-text">YEARS OF <br /> EXPERIENCE</span>
                                </div>
                            </div>
                        </div>

                        <div className="sad-agency-who">
                            ...
                            <button className="sad-agency-btn">OUR PROCESS</button>
                            <div className="sad-agency-image-wrap secondary">
                                <img src={sadDashboardImg} alt="Software Analytics" />
                            </div>
                        </div>

                        <div className="sad-agency-why">
                            <h4 className="sad-agency-small-title">WHY CHOOSE US</h4>
                            <ul className="sad-agency-list">
                                <li>
                                    <span className="sad-check-icon">✓</span>
                                    <span>Top Guaranteed Quality</span>
                                </li>
                                <li>
                                    <span className="sad-check-icon">✓</span>
                                    <span>Team of Senior Developers</span>
                                </li>
                                <li>
                                    <span className="sad-check-icon">✓</span>
