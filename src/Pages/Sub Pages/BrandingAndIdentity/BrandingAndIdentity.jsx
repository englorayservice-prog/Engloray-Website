            ...
            <section className="bi-elevate-section">
                <div className="bi-el-container">
                    <div className="bi-el-left">
                        ...
                        <img src="https://images.unsplash.com/photo-1509343256512-d77a5cb3791b?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" alt="Branding & Identity" className="bi-el-img-small-bottom" />
                    ...
                    <div className="bi-agency-grid">
                        ...
                        <div className="bi-agency-right">
                            ...
                            <div className="bi-agency-bottom-img-wrap">
                                ...
                                <img src={landscapeImg} alt="Brand Identity Services" className="bi-landscape-img" />
                            </div>
                        </div>
                    </div>
                </div>
