...
const products = [
    { id: 1, title: "SaaS",             description: "Cloud-based software solutions that are scalable, secure, and accessible anytime, anywhere.",                                                                                                                                                                                                                                                             bg: "#ffffff", text: "#111827", route: "/saasPage"                     },
    { id: 2, title: "ERP",              description: "Unified management platform for enterprises, schools, and colleges, streamlining academics, finance, and operations.",                                                                                                                                                                                                                                     bg: "#ffffff", text: "#111827", route: "/erpPage"                      },
    { id: 3, title: "Business Suite AI",description: "AI-powered business tools that automate operations, improve decisions, and boost productivity. Our intelligent tools give your business a cutting edge by streamlining workflows and reducing manual effort. They enable real-time insights and smarter strategies to help organizations grow faster and operate more efficiently. With seamless integrations and advanced analytics, businesses can unlock deeper visibility into their operations. This empowers teams to innovate faster, optimize resources, and achieve sustainable growth in a competitive digital landscape.", bg: "#c62828", text: "#FFFFFF", route: "/products/business-suite-ai", isLarge: true, hasShield: true },
    { id: 4, title: "CRM",              description: "Smart customer relationship tools to manage leads, sales, and customer engagement seamlessly.",                                                                                                                                                                                                                                                             bg: "#ffffff", text: "#111827", route: "/crmpage"                      },
    { id: 5, title: "AI Chatbot",       description: "Intelligent conversational assistants that provide instant support and enhance user experience.",                                                                                                                                                                                                                                                          bg: "#ffffff", text: "#111827", route: "/aiChatbotPage"                },
    { id: 6, title: "Job Seeker",       description: "A smart platform connecting talent with opportunities through AI-driven job matching.",                                                                                                                                                                                                                                                                    bg: "#ffffff", text: "#111827", route: "/jobSeekerPage"                },
    { id: 7, title: "Learning & Career",description: "Interactive learning systems designed to upskill individuals and accelerate career growth.",                                                                                                                                                                                                                                                               bg: "#ffffff", text: "#111827", route: "/learningPage"                 },
];
...
const ProductsSection = () => {
    ...
    return (
        <section className="ps-section" id="productsSection">
                ...
                <div className="ps-cards-grid">
                    {products.map((product, i) => (
                        ...
                        >
                            ...
                            {/* Shield/AI animation for large card */}
                            {product.hasShield && (
                                <div className="ps-ai-animation-wrapper">
                                    ...
                                    <div className="ps-ai-node ps-ai-node-1"><FontAwesomeIcon icon={faLaptopCode} /></div>
                                    <div className="ps-ai-node ps-ai-node-2"><FontAwesomeIcon icon={faServer} /></div>
                                    <div className="ps-ai-node ps-ai-node-3"><FontAwesomeIcon icon={faDatabase} /></div>
                                    <div className="ps-ai-node ps-ai-node-4"><FontAwesomeIcon icon={faCloud} /></div>
                                </div>
                            )}
                        </motion.div>
                    ))}
